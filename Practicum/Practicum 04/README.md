...
Дефинирайте функция, която приема 5-цифрено число n. Ако подаденото число n не е 5-цифрено, да се изведе подходящо съобщение. В случай, че n е 5-цифрено, да се сортират цифрите на числото и да се отпечата резултата. 
...
Ако числото съдържа 0-ли, то да се изведе без водещи 0-ли.

## 🔧 Задача 16*

Да се състави програма, която въвежда от клавиатурата две цели числа k и l и извежда числата в интервала [k, l], 0 < K < L <= 100000, които имат съседни еднакви цифри в записа си в десетична бройна система. Използвайте функция, за да проверите дали число има еднакви цифри в десетичния си запис.
